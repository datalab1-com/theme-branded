<div id="footer">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-4">
			<div class="footerPanel">
				<h4 class="letter-spacing-5">LEGAL</h4>
				<ul class="list-unstyled">
					<li><span class="glyphicon glyphicon-triangle-right"></span><a href="/pages/terms-and-conditions" >Terms and Conditions</a></li>
					<li><span class="glyphicon glyphicon-triangle-right"></span><a href="/pages/privacy-policy" >Privacy Policy</a></li>
				</ul>
			</div>
			</div><!-- col -->
			...
			<div class="col-md-3 col-sm-4">
			<div class="footerPanel">
				<h4 class="letter-spacing-5">SUPPORT</h4>
				<ul class="list-unstyled">
					<li><span class="glyphicon glyphicon-triangle-right"></span><a href="/contacts/add">Contact Us</a></li>
					<li><span class="glyphicon glyphicon-triangle-right"></span><a href="/users/login">Login</a></li>
				</ul>
